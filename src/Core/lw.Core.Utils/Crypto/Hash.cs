...
namespace lw.Core.Utils.Crypto;
...
public class Hash
{
	...
	public static string GetHash(byte[] data, HashType hashType)
	{
		...
		{
			case HashType.MD5:
				///TODO: hashString = GetMD5(data);
				break;
			case HashType.SHA1:
				///TODO: hashString = GetSHA1(text);
				break;
			case HashType.SHA256:
				hashString = GetSHA256(data);
				break;
			case HashType.SHA512:
				///TODO: hashString = GetSHA512(text);
				break;
			default:
				hashString = "Invalid Hash Type";
				break;
	...
	private static string GetSHA256(byte[] message)
	{			
		byte[] hashValue;
